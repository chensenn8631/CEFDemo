...
// disable DUITRACE for we don't need it, and we don't known it.
#define DUITRACE
...
public:
    ...
    void Unsubclass();
    virtual void ShowWindow(bool bShow = true, bool bTakeFocus = true);			//将其设置为虚函数，以便子类可以实现自己的功能
    UINT ShowModal();	
    void Close(UINT nRet = IDOK);
    virtual void CenterWindow();	// 将其设置为虚函数，以便子类可以实现自己的功能
