...
typedef enum EVENTTYPE_UI
{
    ...
    UIEVENT_COMMAND,
    UIEVENT__LAST,
	UIEVENT_CHANGE_lANGUAGE_VERSION,
	UIEVENT_CHANGE_lANGUAGE_VERSION_BUTTON,
	UIEVENT_CHANGE_LANGUAGE_VERSION_EDIT,
};
...
public:
	...
	static bool SetLanguageEnvironment(LPCTSTR pCnPath, LPCTSTR pEnPath, bool bDefaultLanguage = true /*-true:Chinese false:English-*/);
	...
	bool AddControl(CControlUI* pControl, ControlType nControlType, LPCTSTR pControlID, LPCTSTR info = _T(""));
...
public:
	...
	static CDuiString GetLanguage(LPCTSTR id);
};
